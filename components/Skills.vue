...
@keyframes glitch-1 {
  ...
  5% { clip: rect(83px, 1000px, 102px, 0); }
  10% { clip: rect(46px, 1000px, 24px, 0); }
  15% { clip: rect(35px, 1000px, 56px, 0); }
  20% { clip: rect(92px, 1000px, 78px, 0); }
  25% { clip: rect(20px, 1000px, 51px, 0); }
  100% { clip: rect(20px, 1000px, 51px, 0); }
}

@keyframes glitch-2 {
  0% { clip: rect(25px, 1000px, 40px, 0); }
  5% { clip: rect(92px, 1000px, 29px, 0); }
  10% { clip: rect(53px, 1000px, 84px, 0); }
  15% { clip: rect(16px, 1000px, 96px, 0); }
  20% { clip: rect(38px, 1000px, 13px, 0); }
  25% { clip: rect(25px, 1000px, 40px, 0); }
  100% { clip: rect(25px, 1000px, 40px, 0); }
}
